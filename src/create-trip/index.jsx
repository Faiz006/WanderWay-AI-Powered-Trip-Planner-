...
function CreateTrip() {
  ...
  const OnGenerateTrip = async () => {
    ...
    if (
      ...
      toast("Kindly complete all fields before proceeding.");
      return;
    }

    if (formData.noOfDays > 10) {
      console.log("Trip duration cannot exceed 10 days.");
      return;
    }
        ...
        <DialogContent>
          <DialogHeader>
            <DialogDescription>
              ...
              <Button onClick={login} className="w-full my-5 flex gap-4 items-center">
                <FcGoogle className="h-4 w-7" />
                Sign In With Google
              </Button>
            </DialogDescription>
          </DialogHeader>
